...
<head>
    ...
    <title>Welcome Back | DullStore Admin</title>
    ...
    <div class="login-card">
        ...
        <div class="w-full lg:w-1/2 p-12 lg:p-16 flex flex-col justify-center">
            <div class="mb-12 fade-up">
                <p class="text-xs font-black uppercase tracking-[0.3em] text-gray-400 mb-2">DullStore Admin</p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="fade-up delay-1">
                    <div class="relative group">
                        ...
                        <div class="absolute right-6 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#080d1a] transition-colors">
                ...
                <div class="fade-up delay-2">
                    <div class="relative group">
                        ...
                        <div class="absolute right-6 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-[#080d1a] transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17.086V19a1 1 0 01-1 1h-2a1 1 0 01-1-1v-2a1 1 0 01.293-.707L9.414 13.172A6 6 0 1121 9z" /></svg>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between fade-up delay-3">
                    <div class="flex items-center">
                        <input type="checkbox" name="remember" id="remember" class="w-4 h-4 rounded border-gray-200 text-[#080d1a] focus:ring-[#080d1a] focus:ring-offset-0 transition-all">
                        <label for="remember" class="ml-3 text-xs font-medium text-gray-400">Remember me</label>
                    </div>
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-xs font-bold text-gray-300 hover:text-gray-600 transition-colors">Forgot password?</a>
                    @endif
                </div>

                <div class="pt-4 fade-up delay-3">
                    <button type="submit" class="w-full lg:w-fit bg-[#080d1a] hover:bg-black text-white font-bold px-10 py-4 rounded-2xl shadow-2xl shadow-blue-900/10 active:scale-[0.97] transition-all duration-300">
                        Sign in
                    </button>
                </div>
            </form>
            ...
            <div class="mt-12 flex items-center space-x-4 fade-up delay-3">
                ...
                <div class="flex space-x-3">
                    <div class="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center text-gray-400 hover:border-gray-900 hover:text-gray-900 cursor-pointer transition-all">
        ...
        <div class="hidden lg:flex w-1/2 bg-[#f8f9fc] items-center justify-center relative overflow-hidden">
            <div class="illustration-blob">
                <img src="/login_illustration_1778703227416.png" class="w-full h-full object-cover scale-110" alt="Illustration">
            </div>
